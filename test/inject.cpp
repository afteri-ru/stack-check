...
[[clang::optnone]] void inject_function() {}
...
int main() {
  // O0: define dso_local noundef i32 @main() #1 {
  // O3: define dso_local noundef i32 @main() local_unnamed_addr #1 {
  ...
  inject_function();
  // O0-NEXT: call void check_overflow(i64 noundef 100)
  // O0-NEXT: call void @_Z16correct_functionv()

  // O3-NEXT: call void check_overflow(i64 noundef 100)
  // O3-NEXT: call void @_Z16correct_functionv()
  

   TestClass::inject_method();
  // O0-NEXT: call void check_overflow(i64 noundef 99)
  // O0-NEXT: call void @_ZN9TestClass13inject_methodEv()

  // O3-NEXT: call void check_overflow(i64 noundef 99)
